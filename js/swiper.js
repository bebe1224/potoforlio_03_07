...
function updateSlideData(slideIndex) {
  ...
  const descriptions = [
    "attachment: fixed,반응형", "form태그,transform 활용", "hover활용", "gsap,탭메뉴,반응형 활용", "Animation,video태그 활용",
    "준비중", "준비중", "준비중", "준비중", "position: sticky, font활용",
    "swiper, 무한 루프 활용", "스크롤 기반 섹션 활성화", "클릭 이벤트 기반 탭 전환", "드롭다운메뉴,드래그 활용", "스와이프 진입 애니,섹션스크롤",
    "아이프레임, 스와이프 액티브", "탭메뉴 심화, SVG호버효과 "
  ];
